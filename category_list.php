...
<body>
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
		      ...
		      <h1 id="logo-text"><a href="index.php" title="">K!</a></h1>
				<p id="intro">Climb for success!</p>
   ...
   <footer>
      ...
      <div class="row"> 
         ...
         <p class="copyright">&copy; Copyright 2023. The Blog. &nbsp; Design by <a title="Training with live project" href="http://www.trainingwithliveproject.com/p/php-tutorials.html">Training with live project</a>.</p>
